package com.jerry.springboot_file_upload.web;

import com.jerry.springboot_file_upload.storage.StorageFileNotFoundException;
...
public class FileUploadController {
   ...
   @ResponseBody
    ...
    public ResponseEntity handle(StorageFileNotFoundException exc)
    {
